        ...
        me.columns  = [
            ...
            { 
                ...
                tpl     : new Ext.XTemplate(
					...
					'<tpl if="type==\'lan\'"><div class="fieldBlueWhite"><i class="fa fa-quote-right"></i> '+' '+'LAN'+'</div></tpl>',
					'<tpl if="type==\'wan\'"><div class="fieldBlueWhite"><i class="fa fa-quote-right"></i> '+' '+'WAN'+'</div></tpl>'
                ),
