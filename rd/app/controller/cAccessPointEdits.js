Ext.define('Rd.controller.cAccessPointEdits', {
    ...
    init: function() {
        ...
        me.control({
            ...
            'winAccessPointAddEntry #ieee80211r': {
                change: me.chkBssChange
            },
            'winAccessPointAddEntry #rsn_preauth': {
                change: me.chkRsnPreauthChange
            },				
            ...
            'winAccessPointEditEntry #rsn_preauth': {
                change: me.chkRsnPreauthChange
            },
            'winAccessPointEditEntry #ieee80211r': {
                change: me.chkBssChange
            },			
    ...
    cmbEncryptionChange: function(cmb){
		...
		//wifimedia options fastroaming
		var rsn		= form.down('#rsn_preauth');
		var bss		= form.down('#ieee80211r');
		var nasid		= form.down('#nasid');
		var fds		= form.down('#ft_over_ds');
		var ftg		= form.down('#ft_psk_generate_local');
        ...
        if(val =='psk2'){
            ...
            scrt.setDisabled(true);
			rsn.setVisible(true);
			rsn.setDisabled(false);
			bss.setVisible(true);
			bss.setDisabled(false);
			nasid.setVisible(true);
			nasid.setDisabled(false);
			//fds.setVisible(true);
			//fds.setDisabled(false);			
        }
        if((val == 'wpa')|(val == 'wpa2')){
            key.setVisible(false);
            key.setDisabled(true); 
	...
	//Rsn_Preauth or 802.11R
    chkRsnPreauthChange: function(chk){
        var me      = this;
        var form    = chk.up('form');
        var bss		= form.down('#ieee80211r'); 
		var fds		= form.down('#ft_over_ds'); 		
