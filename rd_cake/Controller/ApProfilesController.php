...
class ApProfilesController extends AppController {
    ...
    public function ap_profile_entries_index(){
        ...
        foreach($q_r as $m){
            ...
            array_push($items,array( 
                ...
                'connected_to_exit' => $connected_to_exit, //wifimedia option
				'rsn_preauth'  => $m['ApProfileEntry']['rsn_preauth'],
				'ieee80211r'  => $m['ApProfileEntry']['ieee80211r'],
				'ft_over_ds'  => $m['ApProfileEntry']['ft_over_ds'],
				'ft_psk_generate_local'  => $m['ApProfileEntry']['ft_psk_generate_local'],
				'nasid'  => $m['ApProfileEntry']['nasid']
            ));
        }
        //___ FINAL PART ___
        $this->set(array(
    ...
    public function ap_profile_entry_edit(){
        ...
        if ($this->request->is('post')) {
            ...
            $check_items = array('hidden','isolate','apply_to_all','chk_maxassoc','rsn_preauth','ieee80211r','ft_over_ds','ft_psk_generate_local');
