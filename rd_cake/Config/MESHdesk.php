...
$config['Meshes']['captive_portal']['radius_1']         = '45.118.145.52'; // This will be the public IP Address of the FreeRADIUS / RADIUSdesk
//$config['ApProfiles']['captive_portal']['radius_2']         = '45.118.145.52'; //Optional second fallback RADIUS
...
$config['Meshes']['captive_portal']['uam_url']          = 'http://45.118.145.52/cake3/rd_cake/dynamic-details/chilli-browser-detect/'; 
$config['Meshes']['captive_portal']['uam_secret']       = 'greatsecret'; //Usually you will not change this value

//$config['ApProfiles']['captive_portal']['walled_garden'] = "rd.wifimedia.vn,www.google.com"; //Optional
...
$config['common_node_settings']['country']	        = 'VN'; 	//Take the value from $config['MESHdesk']['countries']
$config['common_node_settings']['tz_name']	        = 'Asia/Ho_Chi_Minh'; 	//Take the name from $config['MESHdesk']['countries']
$config['common_node_settings']['tz_value']	        = 'ICT-7'; 	//Take the name from $config['MESHdesk']['countries']
